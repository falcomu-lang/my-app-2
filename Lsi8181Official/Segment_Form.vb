Public Class Segment_Form
    ...
    Sub Apply()
        ...
        For i = 0 To 2
            Status = LSI8181_segment_control_write(CardID, i, s_control(i).SelectedIndex)
    ...
    Private Sub Mask_ComboBox_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Mask_ComboBox.SelectedIndexChanged
        ...
        Dim mode As Byte = Mask_ComboBox.SelectedIndex
    ...
    Public Sub ApplySavedSettingsToCard()
        Initial()
        Apply()
        Status = LSI8181_mask_off_write(CardID, Mask_ComboBox.SelectedIndex)
    End Sub
End Class